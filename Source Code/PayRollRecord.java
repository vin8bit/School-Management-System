...
public class PayRollRecord extends JFrame implements ActionListener
{
	JTextField tf1;
	JButton b1,b2;
	String columns[]={"ID","Name","Basic Salary","Designation","Pay Mode","Net Salary","Date"};
	TableModel tmodel;
	JTable jtable;
	...
	public PayRollRecord()
	{
		...
		try
			...
			rs= stm.executeQuery("SELECT *  FROM payroll ");	
