...
public class EditPayRoll extends JFrame implements ActionListener{
	    ...
	    ResultSet rs2 ;
            ...
            EditPayRoll(){
                 ...
                 jPanel.add(logo);
                 JLabel heading = new JLabel("Edit PayRoll ");
                 heading.setBounds(200,5,350,100);  
                 ...
                 l5 = new JLabel("Pay mode  :");
                 l5.setBounds(280,200,100,25);
                 l6 = new JLabel("Net Salary :");
                 l6.setBounds(70,240,100,25);
                 l7 = new JLabel("Pay Date :");
                 ...
                 ltf1 = new JTextField();
                 ltf1.setBounds(150,80,340,25);
                 ltf2 = new JTextField();
                 ltf2.setBounds(150,120,340,25);
                 ltf3 = new JTextField();
                 ltf3.setBounds(150,160,340,25);
                 ltf4 = new JTextField();
                 ltf4.setBounds(150,200,120,25);
                 ltf5 = new JTextField();
                 ltf5.setBounds(360,200,130,25);
                 ltf6 = new JTextField();
                 ltf6.setBounds(150,240,340,25);
                 ltf7 = new JTextField();
                 ltf7.setBounds(150,280,340,25);
                 ...
                 save.setBounds(70,340,100,25);
                 save.addActionListener(this);

                 search = new JButton("Search");
                 search.setBounds(230,340,100,25);
                 search.addActionListener(this);

                 delete = new JButton("Delete");
                 delete.setBounds(380,340,100,25);
     ...
     public void actionPerformed(ActionEvent e){
                  s1="";s2="";s3="";s4="";s5="";s6="";s7="";s8="";s9="";s10="";s11="";s12="";                       
                    if(e.getSource()== save){
                         ...
                         if(s1.isEmpty()||s2.isEmpty()||s3.isEmpty()||s4.isEmpty()||s6.isEmpty()||s7.isEmpty()){
					...
					for(int y2=0;y2<i2.length(); ++y2)
					{
						...
						{  pass2=7;  check1=1; }
      							...
      							PreparedStatement preparedStmt = con.prepareStatement("delete payroll fees where id = ?");
      							preparedStmt.setString(1, s1);
      							preparedStmt.execute();
      							con.close();
							conn = DriverManager.getConnection(url,userName,password);
							psmt =  conn.prepareStatement("insert into payroll values(?,?,?,?,?,?,?)");
			                	        psmt.setString(1,s1);
							psmt.setString(2,s2);
							psmt.setString(3,s3);
                                                        psmt.setString(4,s4);
							...
							conn.close();
                                                             ...
                                                             if(check1==1){ JOptionPane.showMessageDialog(this,"Invalid net salary !","Error",JOptionPane.ERROR_MESSAGE);}
                                                       }
						...
						if(!dl.isEmpty()){
							...
							if(de==1){ 
								...
								try{	
									...
									conn = DriverManager.getConnection(url,userName,password);
									stm2=conn.createStatement();
									rs2= stm2.executeQuery("SELECT  *  FROM payroll WHERE id="+dl+" ");
           ...
           if(e.getSource()== delete){
                         ...
                         if(s1.isEmpty()||s2.isEmpty()||s3.isEmpty()||s4.isEmpty()||s6.isEmpty()){
                                JOptionPane.showMessageDialog(this,"Some field is empty !","Error",JOptionPane.ERROR_MESSAGE);                           
                                         ...
                                         try {          Connection con = DriverManager.getConnection(url,userName,password);
      							PreparedStatement preparedStmt = con.prepareStatement("delete from payroll where id = ?");
      							preparedStmt.setString(1, s1);
      							preparedStmt.execute();
      							con.close(); 
