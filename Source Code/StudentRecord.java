...
public class StudentRecord extends JFrame implements ActionListener
{
	JTextField tf1;
	JButton b1,b2;
	String columns[]={"ID","Name","Father Name","Religion","Nationality","Address","Mobile no","City","Gender","class","D.O.B","Admission Date"};
	TableModel tmodel;
	JTable jtable;
	...
	public StudentRecord()
	{
		...
		try
			...
			rs= stm.executeQuery("SELECT *  FROM admission ");	
		...
		JLabel l1=new JLabel("Students Records");
