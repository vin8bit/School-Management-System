...
public class DeleteAdmissionFrame extends JFrame implements ActionListener{
	    ...
	    ResultSet rs2 ;
            ...
            DeleteAdmissionFrame(){
                 ...
                 JLabel heading = new JLabel("Delete Student Form ");
                 heading.setBounds(180,5,350,100);  
                 heading.setFont(new Font("Ravie",Font.BOLD,20));              
                 jPanel.add(heading);
		 ...
		 classbox.addItemListener(new ItemListener(){
				public void itemStateChanged(ItemEvent i){
                 ...
                 save.setBounds(70,420,140,25);
                 save.addActionListener(this);
             
                 search = new JButton("Search");
                 search.setBackground(new Color(0,255,255));
                 search.setBounds(350,420,130,25);
					...
					for(int y2=0;y2<i2.length(); ++y2)
					{
						...
						{  pass2=7;  check1=1; }
							...
							Connection con = DriverManager.getConnection(url,userName,password);
      							PreparedStatement preparedStmt = con.prepareStatement("delete from admission where id = ?");
      							preparedStmt.setString(1, s1);
      							preparedStmt.execute();
                                                        JOptionPane.showMessageDialog(this,"Delete data successful !","Success",JOptionPane.INFORMATION_MESSAGE);
						...
						if(!dl.isEmpty()){
							...
							if(de==1){ 
								...
								try{	
									...
									conn = DriverManager.getConnection(url,userName,password);
									stm2=conn.createStatement();
									rs2= stm2.executeQuery("SELECT  *  FROM admission WHERE id="+dl+" ");
