...
public class PayRoll extends JFrame implements ActionListener{
	    ...
	    ResultSet rs2 ;
            ...
            PayRoll(){
                 ...
                 JLabel heading = new JLabel("PayRoll ");
                 ...
                 save.setBounds(70,340,150,25);
                 save.addActionListener(this);

                 search = new JButton("Search");
                 search.setBounds(330,340,150,25);
						...
						if(!dl.isEmpty()){
							...
							if(de==1){ 
								...
								try{	
									...
									ltf3.setText(rs2.getString(10));
                                                                        ltf4.setText(rs2.getString(14));
